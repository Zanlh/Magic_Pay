...
(function() {
    ...
    function U(a, b) {
        ...
        for (
            b = { text: "", bytes: [], chunks: [], version: b }; 4 <= a.available();
            ...
            if (d === t.ECI)
                ...
                for (var f = "", g = e.readBits([10, 12, 14][c]); 3 <= g;) {
                    var h = e.readBits(10);
                    if (1e3 <= h)
                        throw Error("Invalid numeric value above 999");
    ...
    function Z(a, b, c) {
        ...
        6 < b.versionNumber &&
            (f.setRegion(e - 11, 0, 3, 6, !0),
                f.setRegion(0, e - 11, 6, 3, !0));
        b = f;
        g = [];
        e = h = 0;
        f = !0;
    ...
    function ea(a, b, c) {
        ...
        if (1 < d.ecBlocks.length)
            for (
                g = d.ecBlocks[0].numBlocks, b = d.ecBlocks[1].numBlocks, c = 0; c < b; c++
            )
    ...
    function ha(a, b) {
        var c = fa({ x: 3.5, y: 3.5 }, { x: b.dimension - 3.5, y: 3.5 }, { x: b.dimension - 6.5, y: b.dimension - 6.5 }, { x: 3.5, y: b.dimension - 3.5 }),
            ...
            for (let b = -1; b <= a.width; b++) {
                ...
                if (h === g) f++;
                    ...
                    if (h) {
                        ...
                        0 < k.length ?
                            (k[0].bottom = h) :
                            e.push({ top: h, bottom: h });
                    }
                }
            }
            b.push(
                ...c.filter(
                    (a) => a.bottom.y !== m && 2 <= a.bottom.y - a.top.y
                )
            );
        ...
        for (var m of b)
            ...
            ((b =
                ...
                ((f = [
                    ...
                    (f = x(f) / f.length),
                    (g = O({ x: Math.round(b), y: Math.round(e) }, [1, 1, 3, 1, 1],
                        a
                    )),
        ...
        b = b
            .map((b) => {
                ...
                if (a.get(Math.floor(c), Math.floor(b))) {
                    var d =
                        O({ x: Math.floor(c), y: Math.floor(b) }, [1, 1, 1],
                            a
                        ) + y({ x: c, y: b }, n);
            ...
            if (c)
                return {
                    ...
                    location: {
                        ...
                        bottomRightCorner: b.mappingFunction(
                            e.dimension,
                            e.dimension
                        ),
    ...
    function I(a, b, c, d = {}) {
        ...
        f &&
            (h ?
                ((a = new Uint8ClampedArray(a.buffer, n, k)),
                    (q = new A(a, b))) :
                (q = A.createEmpty(b, c)));
        for (b = 0; b < l; b++)
            for (a = 0; a < g; a++) {
    ...
    class V {
        ...
        readBits(a) {
            ...
            if (0 < this.bitOffset) {
                ...
                b -= c;
                b =
                    (this.bytes[this.byteOffset] & ((255 >> (8 - c)) << b)) >>
                    b;
                a -= c;
                this.bitOffset += c;
                8 === this.bitOffset &&
            ...
            if (0 < a) {
                ...
                0 < a &&
                    ((c = 8 - a),
                        (b =
                            (b << a) |
                            ((this.bytes[this.byteOffset] & ((255 >> c) << c)) >>
                                c)),
                        (this.bitOffset += a));
            }
            return b;
        ...
        constructor(a, b) {
            ...
            if (1 < c && 0 === b[0]) {
                ...
                if (d === c) this.coefficients = a.zero.coefficients;
                    ...
                    for (
                        this.coefficients = new Uint8ClampedArray(c - d), a = 0; a < this.coefficients.length; a++
                    )
    ...
    class Y {
        constructor(a, b, c) {
            ...
            for (b = 0; b < this.size; b++)
                ...
                (a *= 2),
                a >= this.size &&
                (a = (a ^ this.primitive) & (this.size - 1));
