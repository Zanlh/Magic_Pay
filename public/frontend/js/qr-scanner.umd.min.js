...
(function(d, a) {
    ...
    class d {
        ...
        constructor(
            ...
            "number" === typeof f
                ?
                ((this._legacyCanvasSize = f),
                    console.warn(
                        "You're using a deprecated version of the QrScanner constructor which will be removed in the future"
                    )) :
                (this._calculateScanRegion = f);
            ...
            document.body.contains(a) ||
                (document.body.appendChild(a), (g = !0));
        ...
        hasFlash() {
            ...
            return (
                    ...
                    this._getCameraStream().then(({ stream: b }) => {
                        console.warn(
        ...
        turnFlashOff() {
            if (this._flashOn)
                return (this._flashOn = !1), this._restartVideoStream();
        }
        destroy() {
        ...
        start() {
            ...
            return this.$video.srcObject ?
                (this.$video.play(), Promise.resolve()) :
                this._getCameraStream()
                .then(({ stream: a, facingMode: b }) => {
        ...
        pause(a = !1) {
            ...
            let b = () => {
                ...
                for (const b of a)
                    b.stop(), this.$video.srcObject.removeTrack(b);
                this.$video.srcObject = null;
            };
            return a ?
                (b(), Promise.resolve(!0)) :
                new Promise((a) => setTimeout(a, 300)).then(() => {
                    ...
                    return c instanceof Worker ?
                        (h ||
                            ...
                            new Promise((a, b) => {
                                ...
                                c.postMessage({ type: "decode", data: m }, [
                                    m.data.buffer,
                                ]);
                            })) :
                        new Promise((a, b) => {
                            let k = setTimeout(
                                () => b("Scanner error: timeout"),
                                1e4
                            );
                            c.detect(f)
                                .then((c) => {
        ...
        _getCameraStream() {
            ...
            return [
                ...
                (a, b) => () =>
                navigator.mediaDevices
                .getUserMedia({ video: b, audio: !1 })
                .then((a) => ({
                    stream: a,
                    facingMode: this._getFacingMode(a) ||
                        (b.facingMode ?
        ...
        static _drawToCanvas(a, b = null, c = null, f = !1) {
            ...
            f ||
                ((f = b && b.downScaledWidth ? b.downScaledWidth : h),
                    (b = b && b.downScaledHeight ? b.downScaledHeight : l),
                    c.width !== f && (c.width = f),
    ...
    d.WORKER_PATH = "frontend/js/qr-scanner-worker.min.js";
    return d;
});
